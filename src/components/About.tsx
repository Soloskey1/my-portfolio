  ...
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="w-20 h-1 bg-gradient-to-r from-cyan-400 to-green-500 mx-auto mb-12"></div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              <span className="px-4 py-2 bg-slate-800 text-green-300 rounded-full text-sm">
                React
              </span>
              <span className="px-4 py-2 bg-slate-800 text-green-300 rounded-full text-sm">
                TypeScript
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="bg-green-700/10 backdrop-blur-sm p-6 rounded-xl border border-slate-700 hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10">
